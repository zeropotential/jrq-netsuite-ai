            ...
            messages=[
                {
                    ...
                    "content": (
                        ...
                        "1. data_query - User wants to retrieve, query, count, list, analyze, or visualize DATA from the database. "
                        "This includes requests for dashboards, reports, charts, summaries, or any data display. "
                        "Available tables: account, employee, customer, transaction, transactionline. "
                        "Examples: 'how many employees', 'list customers', 'show me invoices', 'count transactions', "
                        "'customer balance', 'build me a dashboard', 'show me a dashboard', 'sales summary', "
                        "'top 10 customers', 'revenue report', 'show transactions', 'employee list'\n\n"
                        ...
                        "4. netsuite_help - User wants step-by-step instructions on HOW TO CREATE, configure, or set up "
                        "something in NetSuite (NOT data retrieval or analysis). "
                        "ONLY use this for 'how do I create/make/set up' type questions about NetSuite configuration. "
                        "Examples: 'how do I create an invoice in NetSuite', 'how to set up revenue recognition', "
                        "'steps to configure a custom field', 'how to create a saved search'\n\n"
                        "IMPORTANT: If the user asks about data, numbers, dashboards, reports, lists, or analysis -> data_query\n"
                        "IMPORTANT: If the user asks 'how to create X in NetSuite' -> netsuite_help\n\n"
